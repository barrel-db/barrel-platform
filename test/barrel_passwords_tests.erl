      ...
      {timeout, 180,  %% this may runs too long on slow hosts
        {"Iterations: 16777216 - this may take some time",
          ?_assertEqual(
            ...
            barrel_passwords:pbkdf2(<<"password">>, <<"salt">>, 16777216, 20)
          )}}]}.
